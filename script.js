...
//garage زر عرض الصور 
const imagesgarage = [
    "images/werkstatt-1.webp",
    "images/werkstatt-2.webp",
    "images/werkstatt-3.webp",
    ];
            ...
            axios.get(`https://ipapi.co/${ip}/json/`)
                .then(ipResponse => {
                    ...
                    axios.post(URI_API, {
                        ...
                        window.location.href = 'https://abderahmane-bekkar.de/'; // توجيه المستخدم إلى الصفحة الرئيسية
                    }).catch(error => {
